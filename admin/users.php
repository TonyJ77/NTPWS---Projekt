<?php 
	...
	print '
		<style>
			...
			.button:hover, p a:hover{
				color:#FFFFFF;
				opacity:0.85;
			}
			p,h2,tr,td{color:white;}
		</style>';
			...
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr>
						...
						<td>';
							if ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2) {
								print '<a class="button" href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"><img src="images/edit.png" alt="uredi"></a></td>';
							}
						print '
						<td>';
							if ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2) {
								print '<a class="button" href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img src="images/delete.png" alt="obriši"></a>';
							}
						print '	
						</td>
