...
print'
	<style>
		...
		p a:hover, .AddLink:hover, .button:hover{
			color:#FFFFFF;
			opacity:0.85;
		}
		h2,td,tr{color:white;}
	</style>';
		...
		<div id="news">
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					print '
					<tr>
						<td><a class="button" href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;id=' .$row['id']. '"><img src="images/user.png" alt="user"></a></td>
						<td><a class="button" href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"><img src="images/edit.png" alt="uredi"></a></td>
						<td><a class="button" href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img src="images/delete.png" alt="obriši"></a></td>
						<td>' . $row['title'] . '</td>
						<td>';
